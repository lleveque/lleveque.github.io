...
var $author$project$Planner$AdjustTime = function (a) {
	return {$: 'AdjustTime', a: a};
};
var $elm$core$Platform$Cmd$batch = _Platform_batch;
var $elm$json$Json$Decode$decodeValue = _Json_run;
var $elm$core$Dict$RBEmpty_elm_builtin = {$: 'RBEmpty_elm_builtin'};
var $elm$core$Dict$empty = $elm$core$Dict$RBEmpty_elm_builtin;
var $author$project$Planner$DayPlanning = F2(
	function (morning, afternoon) {
		return {afternoon: afternoon, morning: morning};
	});
var $elm$json$Json$Decode$field = _Json_decodeField;
var $author$project$Planner$Empty = {$: 'Empty'};
var $author$project$Planner$Primary = {$: 'Primary'};
var $author$project$Planner$Secondary = {$: 'Secondary'};
var $elm$json$Json$Decode$andThen = _Json_andThen;
var $elm$json$Json$Decode$string = _Json_decodeString;
var $author$project$Planner$flavourDecoder = A2(
	$elm$json$Json$Decode$andThen,
	function (str) {
		switch (str) {
			case 'primary':
				return $elm$json$Json$Decode$succeed($author$project$Planner$Primary);
			case 'secondary':
				return $elm$json$Json$Decode$succeed($author$project$Planner$Secondary);
			case '':
				return $elm$json$Json$Decode$succeed($author$project$Planner$Empty);
			default:
				return $elm$json$Json$Decode$succeed($author$project$Planner$Empty);
		}
	},
	$elm$json$Json$Decode$string);
var $author$project$Planner$dailyPlanningDecoder = A3(
	$elm$json$Json$Decode$map2,
	$author$project$Planner$DayPlanning,
	A2($elm$json$Json$Decode$field, 'morning', $author$project$Planner$flavourDecoder),
	A2($elm$json$Json$Decode$field, 'afternoon', $author$project$Planner$flavourDecoder));
...
var $author$project$Planner$planningDecoder = $elm$json$Json$Decode$dict($author$project$Planner$dailyPlanningDecoder);
var $author$project$Planner$decodeStoredPlanning = function (planningJson) {
	var _v0 = A2($elm$json$Json$Decode$decodeValue, $author$project$Planner$planningDecoder, planningJson);
	if (_v0.$ === 'Ok') {
		var planning = _v0.a;
		return planning;
	} else {
...
var $author$project$Planner$defaultDateTime = $PanagiotisGeorgiadis$elm_datetime$DateTime$fromPosix(
...
var $author$project$Planner$defaultPlanning = A2(
	$elm$core$Array$repeat,
	5,
	A2(
		$elm$core$Array$repeat,
		7,
		A2($author$project$Planner$DayPlanning, $author$project$Planner$Empty, $author$project$Planner$Empty)));
...
var $author$project$Planner$init = function (flags) {
	return _Utils_Tuple2(
		{
			betterPlanning: function () {
				if (flags.$ === 'Just') {
					var storedPlanning = flags.a;
					return $author$project$Planner$decodeStoredPlanning(storedPlanning);
				} else {
					return $elm$core$Dict$empty;
				}
			}(),
			planning: $author$project$Planner$defaultPlanning,
			primaryColor: '#2a9d8f',
			secondaryColor: '#f4a261',
			selectedDate: $PanagiotisGeorgiadis$elm_datetime$DateTime$getDate($author$project$Planner$defaultDateTime)
		},
		$elm$core$Platform$Cmd$batch(
			_List_fromArray(
				[
					A2($elm$core$Task$perform, $author$project$Planner$AdjustTime, $elm$time$Time$now)
				])));
};
...
var $author$project$Planner$subscriptions = function (model) {
	return $elm$core$Platform$Sub$none;
};
var $author$project$Planner$SelectDate = function (a) {
...
var $author$project$Planner$rotateFlavour = function (flavour) {
	switch (flavour.$) {
		case 'Empty':
			return $author$project$Planner$Primary;
		case 'Primary':
			return $author$project$Planner$Secondary;
		default:
			return $author$project$Planner$Empty;
	}
};
...
var $author$project$Planner$isNotEmpty = F2(
	function (date, planning) {
		var _v0 = _Utils_Tuple2(planning.morning, planning.afternoon);
...
var $author$project$Planner$flavourEncoder = function (flavour) {
	var sFlavour = function () {
		switch (flavour.$) {
			case 'Empty':
				return '';
			case 'Primary':
	...
	return $elm$json$Json$Encode$string(sFlavour);
};
...
var $author$project$Planner$dailyPlanningEncoder = function (planning) {
	return $elm$json$Json$Encode$object(
		_List_fromArray(
			[
				_Utils_Tuple2(
				'morning',
				$author$project$Planner$flavourEncoder(planning.morning)),
				_Utils_Tuple2(
				'afternoon',
				$author$project$Planner$flavourEncoder(planning.afternoon))
			]));
};
...
var $author$project$Planner$planningEncoder = A2($elm$json$Json$Encode$dict, $elm$core$Basics$identity, $author$project$Planner$dailyPlanningEncoder);
var $author$project$Planner$storeData = _Platform_outgoingPort('storeData', $elm$core$Basics$identity);
var $author$project$Planner$saveData = function (planning) {
	return $author$project$Planner$storeData(
		$author$project$Planner$planningEncoder(
			A2($elm$core$Dict$filter, $author$project$Planner$isNotEmpty, planning)));
};
		...
		switch (msg.$) {
			case 'AdjustTime':
				...
				return _Utils_Tuple2(
					...
					A2(
						$elm$core$Task$perform,
						$author$project$Planner$SelectDate,
						$elm$core$Task$succeed(
							$PanagiotisGeorgiadis$elm_datetime$Calendar$incrementMonth(
								$PanagiotisGeorgiadis$elm_datetime$Calendar$fromPosix(newTime)))));
			case 'NextMonth':
				return _Utils_Tuple2(
					model,
					A2(
						...
						$author$project$Planner$SelectDate,
						$elm$core$Task$succeed(
							$PanagiotisGeorgiadis$elm_datetime$Calendar$incrementMonth(model.selectedDate))));
			case 'PreviousMonth':
				return _Utils_Tuple2(
					model,
					A2(
						...
						$author$project$Planner$SelectDate,
						$elm$core$Task$succeed(
							$PanagiotisGeorgiadis$elm_datetime$Calendar$decrementMonth(model.selectedDate))));
			case 'SelectDate':
				var date = msg.a;
				return _Utils_Tuple2(
					_Utils_update(
			...
			default:
				var viewedDate = msg.a;
				var clickedSlot = msg.b;
				var day = A2(
					$elm$core$Maybe$withDefault,
					A2($author$project$Planner$DayPlanning, $author$project$Planner$Empty, $author$project$Planner$Empty),
					A2($elm$core$Dict$get, viewedDate, model.betterPlanning));
				var updatedDay = function () {
					switch (clickedSlot.$) {
						case 'AllDay':
							var _v3 = _Utils_eq(day.morning, day.afternoon);
							if (!_v3) {
								...
								return _Utils_update(
									day,
									{
										afternoon: $author$project$Planner$rotateFlavour(day.afternoon),
										morning: $author$project$Planner$rotateFlavour(day.morning)
									});
							}
						case 'Morning':
							return _Utils_update(
				...
				var updatedBetterPlanning = A3($elm$core$Dict$insert, viewedDate, updatedDay, model.betterPlanning);
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{betterPlanning: updatedBetterPlanning}),
					$author$project$Planner$saveData(updatedBetterPlanning));
		}
	});
var $elm$json$Json$Decode$value = _Json_decodeValue;
var $author$project$Planner$UpdateColor = F2(
	function (a, b) {
		return {$: 'UpdateColor', a: a, b: b};
	});
...
var $author$project$Planner$NextMonth = {$: 'NextMonth'};
var $author$project$Planner$PreviousMonth = {$: 'PreviousMonth'};
...
var $author$project$Planner$monthToString = function (month) {
	switch (month.$) {
		case 'Jan':
			return 'Janvier';
		case 'Feb':
...
var $author$project$Planner$viewMonth = function (date) {
	return A2(
		$elm$html$Html$h1,
		_List_fromArray(
			[
		...
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						$elm$html$Html$Events$onClick($author$project$Planner$PreviousMonth),
				...
				_List_fromArray(
					[
						$elm$html$Html$text(
						$author$project$Planner$monthToString(
				...
				_List_fromArray(
					[
						$elm$html$Html$Events$onClick($author$project$Planner$NextMonth),
						$elm$html$Html$Attributes$class('nav-button')
					]),
				_List_fromArray(
					[
...
var $author$project$Planner$Afternoon = {$: 'Afternoon'};
var $author$project$Planner$AllDay = {$: 'AllDay'};
var $author$project$Planner$Morning = {$: 'Morning'};
var $author$project$Planner$Toggle = F2(
	function (a, b) {
		return {$: 'Toggle', a: a, b: b};
	});
var $elm$virtual_dom$VirtualDom$style = _VirtualDom_style;
var $elm$html$Html$Attributes$style = $elm$virtual_dom$VirtualDom$style;
var $author$project$Planner$flavourStyle = F2(
	function (_v0, flavour) {
		var primaryColor = _v0.a;
		var secondaryColor = _v0.b;
		switch (flavour.$) {
			case 'Empty':
				return A2($elm$html$Html$Attributes$style, 'background', 'none');
			case 'Primary':
				return A2($elm$html$Html$Attributes$style, 'background', primaryColor);
			default:
				return A2($elm$html$Html$Attributes$style, 'background', secondaryColor);
		}
	});
var $author$project$Planner$mask = function (day) {
	var planned = function (a) {
		return _Utils_eq(a, $author$project$Planner$Primary) || _Utils_eq(a, $author$project$Planner$Secondary);
	};
	var _v0 = _Utils_Tuple3(
		planned(day.morning),
		planned(day.afternoon),
		_Utils_eq(day.morning, day.afternoon));
	if (_v0.a) {
		if (_v0.b) {
			if (_v0.c) {
				return $elm$html$Html$Attributes$class('hatched-full');
			} else {
				return $elm$html$Html$Attributes$class('hatched-both');
			}
		} else {
			return $elm$html$Html$Attributes$class('hatched-left');
		}
	} else {
		if (_v0.b) {
			return $elm$html$Html$Attributes$class('hatched-right');
		} else {
			return $elm$html$Html$Attributes$class('hatched-none');
		}
	}
};
var $author$project$Planner$monthNumber = function (month) {
	switch (month.$) {
		case 'Jan':
			return '01';
		case 'Feb':
...
var $author$project$Planner$toOffset = function (weekday) {
	switch (weekday.$) {
		case 'Mon':
			return 0;
		case 'Tue':
...
var $author$project$Planner$offsetAndLimit = function (date) {
	var offset = function () {
		var _v0 = A2($PanagiotisGeorgiadis$elm_datetime$Calendar$setDay, 1, date);
		if (_v0.$ === 'Just') {
			var firstOfMonth = _v0.a;
			return $author$project$Planner$toOffset(
				$PanagiotisGeorgiadis$elm_datetime$Calendar$getWeekday(firstOfMonth));
		} else {
			return 0;
		}
	}();
...
var $author$project$Planner$viewDay = F4(
	function (model, weekNb, dayNb, _v0) {
		var colors = _Utils_Tuple2(model.primaryColor, model.secondaryColor);
		var _v1 = $author$project$Planner$offsetAndLimit(model.selectedDate);
		var offset = _v1.a;
		var limit = _v1.b;
		var day = (((weekNb * 7) + dayNb) - offset) + 1;
		var isAfterMonth = _Utils_cmp(day, limit) > 0;
		var viewedDate = $elm$core$String$fromInt(
			$PanagiotisGeorgiadis$elm_datetime$Calendar$getYear(model.selectedDate)) + ('-' + ($author$project$Planner$monthNumber(
			$PanagiotisGeorgiadis$elm_datetime$Calendar$getMonth(model.selectedDate)) + ('-' + A3(
			$elm$core$String$padLeft,
			2,
			_Utils_chr('0'),
			$elm$core$String$fromInt(day)))));
		var viewedPlanning = A2(
			$elm$core$Maybe$withDefault,
			A2($author$project$Planner$DayPlanning, $author$project$Planner$Empty, $author$project$Planner$Empty),
			A2($elm$core$Dict$get, viewedDate, model.betterPlanning));
		var isBeforeMonth = (!weekNb) && (_Utils_cmp(dayNb, offset) < 0);
		var _v2 = isBeforeMonth || isAfterMonth;
		if (_v2) {
			return A2(
				$elm$html$Html$td,
				_List_fromArray(
					[
						...
						$elm$html$Html$Attributes$class('offlimit')
					]),
				_List_Nil);
		} else {
			var morningStyle = A2($author$project$Planner$flavourStyle, colors, viewedPlanning.morning);
			var dailyMask = $author$project$Planner$mask(viewedPlanning);
			var afternoonStyle = A2($author$project$Planner$flavourStyle, colors, viewedPlanning.afternoon);
			return A2(
				$elm$html$Html$td,
				_List_fromArray(
					[
					...
					[
						...
						_List_fromArray(
							[
								...
								A2($author$project$Planner$Toggle, viewedDate, $author$project$Planner$AllDay))
							]),
						_List_fromArray(
							[
								A2(
							...
							[
								...
								_List_fromArray(
									[
										...
										morningStyle,
										$elm$html$Html$Events$onClick(
										A2($author$project$Planner$Toggle, viewedDate, $author$project$Planner$Morning))
									]),
								_List_Nil),
								A2(
								$elm$html$Html$div,
								_List_fromArray(
									[
										...
										afternoonStyle,
										$elm$html$Html$Events$onClick(
										A2($author$project$Planner$Toggle, viewedDate, $author$project$Planner$Afternoon))
									]),
								_List_Nil)
							]))
					]));
...
var $author$project$Planner$viewWeek = F3(
	function (model, weekNb, _v0) {
		var days = A2($elm$core$List$repeat, 7, false);
		return A2(
			$elm$html$Html$tr,
			_List_fromArray(
				[
			...
			A2(
				...
				A2($author$project$Planner$viewDay, model, weekNb),
				days));
	});
var $author$project$Planner$viewPlanning = function (model) {
	var weeks = A2($elm$core$List$repeat, 5, false);
	return A2(
		$elm$html$Html$table,
		_List_fromArray(
			[
				$elm$html$Html$Attributes$id('planning')
			]),
		A2(
			$elm$core$List$indexedMap,
			$author$project$Planner$viewWeek(model),
			weeks));
};
	...
	return A2(
		...
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						$elm$html$Html$Attributes$id('left-panel')
					]),
				_List_fromArray(
					[
						$author$project$Planner$viewMonth(model.selectedDate),
						A2(
						$elm$html$Html$div,
						_List_fromArray(
							[
							...
							[
								...
								_List_fromArray(
									[
										...
										$elm$html$Html$Attributes$value(model.primaryColor),
										$elm$html$Html$Events$onInput(
										$author$project$Planner$UpdateColor($author$project$Planner$Primary))
									]),
								_List_fromArray(
									[
										$elm$html$Html$text('Couleur A')
									])),
								A2(
								$elm$html$Html$input,
								_List_fromArray(
						...
						_List_fromArray(
							[
								...
								_List_fromArray(
									[
										$elm$html$Html$Attributes$type_('color'),
										$elm$html$Html$Attributes$value(model.secondaryColor),
										$elm$html$Html$Events$onInput(
										$author$project$Planner$UpdateColor($author$project$Planner$Secondary))
									]),
								_List_fromArray(
									[
										$elm$html$Html$text('Couleur B')
									])),
								A2(
								$elm$html$Html$input,
								_List_fromArray(
				...
				$author$project$Planner$viewPlanning(model),
				A2(
				$elm$html$Html$div,
				_List_fromArray(
					[
						$elm$html$Html$Attributes$id('right-panel')
					]),
				_List_Nil)
			]));
};
var $author$project$Planner$main = $elm$browser$Browser$element(
	{init: $author$project$Planner$init, subscriptions: $author$project$Planner$subscriptions, update: $author$project$Planner$update, view: $author$project$Planner$view});
_Platform_export({'Planner':{'init':$author$project$Planner$main(
